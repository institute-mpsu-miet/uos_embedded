 ...
 */
#define INT1R           PIC32_R (0xFA04)
#define INT2R           PIC32_R (0xFA08)
#define INT3R           PIC32_R (0xFA0C)
#define INT4R           PIC32_R (0xFA10)
#define T2CKR           PIC32_R (0xFA18)
#define T3CKR           PIC32_R (0xFA1C)
#define T4CKR           PIC32_R (0xFA20)
#define T5CKR           PIC32_R (0xFA24)
#define IC1R            PIC32_R (0xFA28)
#define IC2R            PIC32_R (0xFA2C)
#define IC3R            PIC32_R (0xFA30)
#define IC4R            PIC32_R (0xFA34)
#define IC5R            PIC32_R (0xFA38)
#define OCFAR           PIC32_R (0xFA48)
#define OCFBR           PIC32_R (0xFA4C)
#define U1RXR           PIC32_R (0xFA50)
#define U1CTSR          PIC32_R (0xFA54)
#define U2RXR           PIC32_R (0xFA58)
#define U2CTSR          PIC32_R (0xFA5C)
#define SDI1R           PIC32_R (0xFA84)
#define SS1R            PIC32_R (0xFA88)
#define SDI2R           PIC32_R (0xFA90)
#define SS2R            PIC32_R (0xFA94)
#define REFCLKIR        PIC32_R (0xFAB8)
