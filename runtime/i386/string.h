...
static __inline unsigned char * strcpy(unsigned char * dest, const unsigned char *src)
{
int d0, d1, d2;
...
static __inline unsigned char * strcat(unsigned char * dest, const unsigned char * src)
{
int d0, d1, d2, d3;
__asm__ __volatile__(
	"cld\n\t"
...
static __inline unsigned char * strchr(const unsigned char * s, unsigned char c)
{
int d0;
...
static __inline unsigned char * strrchr(const unsigned char * s, unsigned char c)
{
int d0, d1;
register unsigned char * __res;
__asm__ (
...
#define memmove(t, f, n) __memmove((t),(f),(n))
