/* uOS interrupt handlers for ATmega128.
 ...
 * Do not edit it manually! */
	...
	HANDLE (29, clearb_r30 (RXCIE, UCSR1B))
	HANDLE (30, clearb_r30 (UDRIE, UCSR1B))
	HANDLE (31, clearb_r30 (TXCIE, UCSR1B))
...
void arch_intr_allow (int irq)
{
	...
	case 29: setb (RXCIE, UCSR1B); break;
	case 30: break;
	case 31: setb (TXCIE, UCSR1B); break;
